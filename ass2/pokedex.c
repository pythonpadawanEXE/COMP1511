...
void save_pokedex(Pokedex pokedex, char *filename) {
    fprintf(stderr, "exiting no save_pokedex function defined\n");
    exit(1);
...
Pokedex load_pokedex(char *filename) {
    fprintf(stderr, "exiting no load_pokedex function defined\n");
    exit(1);
}
...
Pokedex get_pokemon_of_type(Pokedex pokedex, pokemon_type type) {
    fprintf(stderr, "exiting no get_pokemon_of_type function defined\n");
    exit(1);
}
...
Pokedex search_pokemon(Pokedex pokedex, char *text) {
    fprintf(stderr, "exiting no search_pokemon function defined\n");
    exit(1);
}
...
Pokedex end_search(Pokedex sub_pokedex) {
    fprintf(stderr, "exiting no end_search function defined\n");
    exit(1);
}
